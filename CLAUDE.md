...
- Tool: `mcp__claude-flow__agent_spawn`
- Parameters: `{"type": "code-analyzer", "name": "Code Analyzer"}`
...
2. Each agent MUST use Claude Flow hooks for coordination:
   ...
   - `npx claude-flow@alpha memory store` to share decisions
...
[BatchTool]:
  ...
  - mcp__claude-flow__agent_spawn { type: "code-analyzer", name: "Code Analzyer" }
