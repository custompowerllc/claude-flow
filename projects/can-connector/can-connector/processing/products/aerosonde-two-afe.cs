...
Aerosonde_Two_AFE : Product
{
    private const ushort LONG_CMD_AFE_PROGRAM         = 0x7F00;
    private const ushort LONG_CMD_FG_PROGRAM          = 0x7F01;
    private const ushort LONG_CMD_FG_CAL_CC_OFFSET    = 0x7F02;
    private const ushort LONG_CMD_FG_CAL_BOARD_OFFSET = 0x7F03;
    private const ushort LONG_CMD_FG_CAL_VOLTAGE      = 0x7F04;
    private const ushort LONG_CMD_FG_CAL_CURRENT      = 0x7F05;
    private const ushort LONG_CMD_RESPONSE_BIT        = 0x8000;
    ...
    new()
    {
        ...
        new()
        {
            ...
            arguments = ImmutableArray.Create(("Applied Voltage (V):", "24.5")),
        ...
        new()
        {
            ...
            arguments = ImmutableArray.Create(("Applied Current (A):", "-3.0")),
            response_timeout = 12_000
        }
    };
    ...
    (CAN_ID a_id, in ReadOnlySpan<byte> a_data)
    {
        ...
        a_msg switch
        {
            ...
            0xFu => parse_command_response(a_data),
            _ => null
        };
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        var a_result =
            a_g1.value
            .Append($"Batttery Status: 0x{a_battery_status:X4}; ")
            .Append($"Operation Status: 0x{a_operation_status:X4}; ")
            .Append($"Gauging Status: 0x{a_gauging_status:X4}; ")
            .Append($"Manufacturing Status: 0x{a_manufacturing_status:X4}; ")
            .ToString();
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        var a_result =
            ...
            .Append($"Design Cap: {6 * a_dc}mAh; ")
            .Append($"Full Chg Cap: {6 * a_fcc}mAh; ")
            .Append($"Rem Cap: {6 * a_rc}mAh; ")
            .ToString();
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        var a_result =
            ...
            .Append($"Fuel Gauge Firmware Ver: {a_fg_firmware}; ")
            .ToString();
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        Misc.decode_le(out ushort a_iso_isqc_volt, a_data, ref a_index);
        ...
        var a_result =
            ...
            .Append($"Isolated I2C Monitor: {0.001 * a_iso_isqc_volt:F3}V; ")
            .ToString();
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        var a_result =
            a_g1.value
            .Append($"AFE Temp1: {to_celcius(a_temp1):F1}°C; ")
            .Append($"AFE Temp2: {to_celcius(a_temp2):F1}°C; ")
            .Append($"AFE Current: {0.001 * a_curr:F3}A; ")
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        Misc.decode_le(out ushort a_temp_uc, a_data, ref a_index);
        ...
        var a_result =
            ...
            .Append($"Temp μController: {to_celcius(a_temp_uc):F1}°C; ")
            .ToString();
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        Misc.decode_le(out ushort a_heater_volt, a_data, ref a_index);
        ...
        var a_result =
            a_g1.value
            .Append($"Heater Monitor: {0.001 * a_heater_volt:F3}V; ")
    ...
    (in ReadOnlySpan<byte> a_data)
    {
        ...
        var a_result =
            a_cmd switch
            {
                LONG_CMD_RESPONSE_BIT | LONG_CMD_AFE_PROGRAM         => parse_afe_program(a_data, ref a_index),
                LONG_CMD_RESPONSE_BIT | LONG_CMD_FG_PROGRAM          => parse_fg_program(a_data, ref a_index),
                LONG_CMD_RESPONSE_BIT | LONG_CMD_FG_CAL_CC_OFFSET    => parse_fg_cal_cc_offset(a_data, ref a_index),
                LONG_CMD_RESPONSE_BIT | LONG_CMD_FG_CAL_BOARD_OFFSET => parse_fg_cal_board_offset(a_data, ref a_index),
                LONG_CMD_RESPONSE_BIT | LONG_CMD_FG_CAL_VOLTAGE      => parse_fg_cal_voltage(a_data, ref a_index),
                LONG_CMD_RESPONSE_BIT | LONG_CMD_FG_CAL_CURRENT      => parse_fg_cal_current(a_data, ref a_index),
                _ => null
            };
    ...
    process_afe_program()
    {
        const ushort CMD = LONG_CMD_AFE_PROGRAM;
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index)
    {
        ...
        var a_result =
            a_g1.value
            .Append($"Command 0x{CMD:X4} Response: Program AFE: {(a_success is not 0 ? "SUCCESS" : "FAILURE")}; ")
            .ToString();
    ...
    process_fg_program()
    {
        const ushort CMD = LONG_CMD_FG_PROGRAM;
    ...
    {
        const ushort CMD = LONG_CMD_FG_CAL_CC_OFFSET;
    ...
    {
        const ushort CMD = LONG_CMD_FG_CAL_BOARD_OFFSET;
    ...
    (string a_arg0)
    {
        const ushort CMD = LONG_CMD_FG_CAL_VOLTAGE;
        const double MIN_LIMIT = 21.0;
    ...
    (string a_arg0)
    {
        const ushort CMD = LONG_CMD_FG_CAL_CURRENT;
