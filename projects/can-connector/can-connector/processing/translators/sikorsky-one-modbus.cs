...
Sikorsky_One_Modbus : Translator
{
    public enum
    ...
    (CAN_ID a_can_id, byte[] a_can_data, Protocol a_protocol, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        try
        {
            ...
            (Command_Number)a_cmd switch
            {
                ...
                Command_Number.CMD_FET => process_fet(a_data, ref a_index, a_protocol, a_can_id, a_can_data, a_callback),
                ...
                Command_Number.CMD_FG_IT_EN => process_fg_it_en(a_protocol, a_can_id, a_can_data, a_callback),
                ...
                Command_Number.CMD_PROG_AFE => process_prog_afe(a_protocol, a_can_id, a_can_data, a_callback),
                ...
                Command_Number.CMD_BLINK_EN => process_blink_en(a_data, ref a_index, a_protocol, a_can_id, a_can_data, a_callback),
    ...
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 8u, true);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 9u, a_state is not 0);
        ...
        (
            ...
            a_recv_data =>
            {
                ...
                try
                {
                    ...
                    const ushort CMD = (ushort)(Command_Number.CMD_RESPONSE | Command_Number.CMD_FET);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 10u, true);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 11u, true);
        ...
        (
            ...
            a_recv_data =>
            {
                ...
                try
                {
                    ...
                    const ushort CMD = (ushort)(Command_Number.CMD_RESPONSE | Command_Number.CMD_FG_IT_EN);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_HOLDNGS, 10u, stackalloc ushort[] { a_key_hi, a_key_lo });
    ...
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 13u, a_seal);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_HOLDNGS, 12u, stackalloc ushort[] { a_key_hi, a_key_lo });
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 14u, false);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 15u, true);
        ...
        (
            ...
            a_recv_data =>
            {
                ...
                try
                {
                    ...
                    const ushort CMD = (ushort)(Command_Number.CMD_RESPONSE | Command_Number.CMD_PROG_AFE);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 16u, true);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_HOLDING, 14u, a_applied_volt);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_HOLDING, 15u, a_applied_curr);
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_HOLDNGS, 8u, stackalloc ushort[] { a_sn_hi, a_sn_lo });
    ...
    (in ReadOnlySpan<byte> a_data, ref int a_index, Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_write(SLAVE_ADDR, Modbus_Master.Func_Code.WRITE_SINGLE_COIL, 22u, a_state is not 0);
        ...
        (
            ...
            a_recv_data =>
            {
                ...
                try
                {
                    ...
                    const ushort CMD = (ushort)(Command_Number.CMD_RESPONSE | Command_Number.CMD_BLINK_EN);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_read(SLAVE_ADDR, Modbus_Master.Func_Code.READ_COILS, 8u, 15);
            ...
            a_recv_data =>
            {
                ...
                try
                {
...

                    {
                        ...
                        Misc.decode_be(out a_packet_data.fg_flags_a, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.fg_flags_b, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.fg_pack_configuration, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.fg_learned_status, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_status0, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_status1, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_status2, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_status3, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_control0, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_control1, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_control2, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.afe_control3, a_data_slice, ref a_index);
...

                    {
                        ...
                        Misc.encode_le(a_packet_data.fg_flags_a, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.fg_flags_b, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.fg_pack_configuration, a_send_data, ref a_index);
...

                    {
                        ...
                        Misc.encode_le(a_packet_data.fg_learned_status, a_send_data, ref a_index);
...

                    {
                        ...
                        Misc.encode_le(a_packet_data.afe_status0, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_status1, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_status2, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_status3, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_control0, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_control1, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_control2, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.afe_control3, a_send_data, ref a_index);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        ...
        var a_send_data = Modbus_Master.generate_read(SLAVE_ADDR, Modbus_Master.Func_Code.READ_HOLDINGS, 8u, BYTES / 2);
    ...
    (Protocol a_protocol, CAN_ID a_can_id, byte[] a_can_data, Action<Message_Result<(CAN_ID, byte[])>> a_callback)
    {
        const int BYTES = 40 * 2;

        var a_send_data = Modbus_Master.generate_read(SLAVE_ADDR, Modbus_Master.Func_Code.READ_INPUTS, 8u, BYTES / 2);
            ...
            a_recv_data =>
            {
                ...
                try
                {
...

                    {
                        ...
                        Misc.decode_be(out a_packet_data.fw_version, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.fg_version, a_data_slice, ref a_index);
                        Misc.decode_be(out a_packet_data.serial_number, a_data_slice, ref a_index);
...

                    {
                        ...
                        Misc.encode_le(a_packet_data.fw_version, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.fg_version, a_send_data, ref a_index);
                        Misc.encode_le(a_packet_data.serial_number, a_send_data, ref a_index);
    ...
    Discrete_Data
    {
        ...
        public ushort fg_flags_a;
        public ushort fg_flags_b;
        public ushort fg_pack_configuration;
        public byte fg_learned_status;
        public byte afe_status0;
        public byte afe_status1;
        public byte afe_status2;
        public byte afe_status3;
        public byte afe_control0;
        public byte afe_control1;
        public byte afe_control2;
        public byte afe_control3;
    }
