...
# PowerShell script to run standalone Modbus logger for serial number 0535 (P3E-Report structure)
# Usage: .\run_standalone_0535.ps1
...
$output_base = "test-artifacts\0535"
...
Write-Host "Directory structure ready for pack 0535" -ForegroundColor Green
Write-Host ""
...
Write-Host "Starting standalone logger for pack 0535..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Logging session completed for pack 0535" -ForegroundColor Green
