...
# PowerShell script to run standalone Modbus logger for serial number 0520 (P3E-Report structure)
# Usage: .\run_standalone_0520.ps1

$serial_number = "0520"
$rma_number = "8765"
$COM_PORT = "COM3"  # Default COM port - change as needed
...
$output_base = "test-artifacts\0520"
...
Write-Host "Directory structure ready for pack 0520" -ForegroundColor Green
Write-Host ""
...
Write-Host "Starting standalone logger for pack 0520..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Logging session completed for pack 0520" -ForegroundColor Green
